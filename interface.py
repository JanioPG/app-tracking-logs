...
def title(txt: str) -> None:
    ...
    print(f"{colors.GREEN}{ui_data.Icon.AIRPLANE_DEPARTURE.value}  {txt} {ui_data.Icon.DETECTIVE.value}".center(37), end=f"{colors.CLOSE}\n")
...
def show_program_finished():
    print(f"\n{ui_data.Icon.AIRPLANE_ARRIVAL.value} {colors.LIGHT_GRAY}{ui_data.Message.PROGRAM_FINISHED.value}{colors.CLOSE}")
